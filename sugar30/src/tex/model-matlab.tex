...
\nwalsodefined{\\{NWmodF-modF.2-2}\\{NWmodF-modF.2-3}\\{NWmodF-modF.2-4}\\{NWmodF-modF.2-5}\\{NWmodF-modF.2-6}\\{NWmodF-modF.2-7}\\{NWmodF-modF.2-8}\\{NWmodF-modF.2-9}}\nwused{\\{NWmodF-modE.2-1}}\nwendcode{}\nwbegindocs{8}\nwdocspar
...
\{
    ...
    \LA{}allocate x, v, a handles~{\nwtagstyle{}\subpageref{NWmodF-allO-1}}\RA{}
...
\nwenddocs{}\nwbegincode{21}\sublabel{NWmodF-allO-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWmodF-allO-1}}}\moddef{allocate x, v, a handles~{\nwtagstyle{}\subpageref{NWmodF-allO-1}}}\endmoddef
...
\nwused{\\{NWmodF-modF.2-6}\\{NWmodF-modF.2-7}}\nwendcode{}\nwbegindocs{22}\nwdocspar

\nwenddocs{}\nwbegincode{23}\sublabel{NWmodF-freK-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWmodF-freK-1}}}\moddef{free x, v, a handles~{\nwtagstyle{}\subpageref{NWmodF-freK-1}}}\endmoddef
...
\nwenddocs{}\nwbegincode{25}\sublabel{NWmodF-modF.2-8}\nwmargintag{{\nwtagstyle{}\subpageref{NWmodF-modF.2-8}}}\moddef{model functions~{\nwtagstyle{}\subpageref{NWmodF-modF.2-1}}}\plusendmoddef
...
\nwenddocs{}\nwbegincode{27}\sublabel{NWmodF-modF.2-9}\nwmargintag{{\nwtagstyle{}\subpageref{NWmodF-modF.2-9}}}\moddef{model functions~{\nwtagstyle{}\subpageref{NWmodF-modF.2-1}}}\plusendmoddef
...
\nwixlogsorted{c}{{allocate x, v, a handles}{NWmodF-allO-1}{\nwixu{NWmodF-modF.2-6}\nwixu{NWmodF-modF.2-7}\nwixd{NWmodF-allO-1}}}%
\nwixlogsorted{c}{{free x, v, a handles}{NWmodF-freK-1}{\nwixu{NWmodF-modF.2-6}\nwixu{NWmodF-modF.2-7}\nwixd{NWmodF-freK-1}}}%
\nwixlogsorted{c}{{model functions}{NWmodF-modF.2-1}{\nwixu{NWmodF-modE.2-1}\nwixd{NWmodF-modF.2-1}\nwixd{NWmodF-modF.2-2}\nwixd{NWmodF-modF.2-3}\nwixd{NWmodF-modF.2-4}\nwixd{NWmodF-modF.2-5}\nwixd{NWmodF-modF.2-6}\nwixd{NWmodF-modF.2-7}\nwixd{NWmodF-modF.2-8}\nwixd{NWmodF-modF.2-9}}}%
\nwixlogsorted{c}{{model-matlab.c}{NWmodF-modE.2-1}{\nwixd{NWmodF-modE.2-1}}}%
\nwixlogsorted{c}{{model-matlab.h}{NWmodF-modE-1}{\nwixd{NWmodF-modE-1}}}%
