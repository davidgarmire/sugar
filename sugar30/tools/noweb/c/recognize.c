...
static char rcsid[] = "$Id: recognize.c,v 1.3 2002/04/05 09:49:35 strive Exp $";
...
#line 148 "recognize.nw"
  c = *p++;
  while (c) {
    Goto_Node *new = goto_lookup(c, q);
    if (!new)
      
#line 167 "recognize.nw"
{
...
#line 176 "recognize.nw"
  new->next = r->depths[depth];
  r->depths[depth] = new;
}
#line 153 "recognize.nw"
    q = new;
    depth++;
    c = *p++;
  }
  
#line 190 "recognize.nw"
if (!q->output) {
