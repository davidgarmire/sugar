/*
** $Id: llex.c,v 1.1.1.1 2002/04/05 08:42:49 strive Exp $
** Lexical Analyzer
...
/* ORDER RESERVED 
 * dbindel -- 3/9/02 -- added "subnet" keyword
 */
static const char *const token2string [] = {
    "and", "break", "do", "else", "elseif", "end", "for",
    "function", "subnet", "if", "local", "nil", "not", "or", "repeat", "return", "then",
    "until", "while", "", "..", "...", "==", ">=", "<=", "~=", "", "", "<eof>"};
...
static void read_number (LexState *LS, int comma, SemInfo *seminfo) {
  ...
  if (LS->current == 'a' ||
      ...
      LS->current == 'P' ||
      LS->current == 'E')
    save_and_next(L, LS, l); /* Read optional metric suffix */
